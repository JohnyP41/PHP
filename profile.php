...
if (isset($_GET['pageno'])) {
        ...
        $sql = "SELECT offender_name,bantime,admin_name FROM tf2jr_guardbans_logs WHERE `offender_name`='$search' ORDER BY timestamp DESC LIMIT $offset, $no_of_records_per_page";
